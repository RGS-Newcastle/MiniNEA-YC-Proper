...
### excel
Once I had all my sprites designed I had to find a way to convert them all into a format suitable for storing into a data structure so I could display them on screen. The data structure    
