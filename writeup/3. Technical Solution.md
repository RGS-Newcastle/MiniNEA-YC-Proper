...
For each unique sprite I made a draw function this way.
...
This subroutine works by having a detection zone around the hopper, which if the player moves close enough and there is sand in the hopper list (this is passed in when this subroutine is called which allows me to not have to repeat code for multiple hoppers) the top most sand dictionary is popped. This dictionary is then readded to the active_sand list.  
