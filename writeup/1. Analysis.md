...
### Zelda
This version of "Zelda" has a larger map which is displayed on the upper screen. On the bottom screen the game displays the current map area that Link is in along with the enemies in that area 
